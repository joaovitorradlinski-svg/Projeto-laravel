...
@section('content')
<form action="{{ route('personagens.store') }}" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto mt-8 bg-[#181a20] rounded shadow p-6">
    @csrf
    ...
    <input type="text" name="classe" id="classe" class="w-full px-3 py-2 rounded bg-[#23272f] border border-gray-700 text-gray-100 mb-4"/>

    <label for="raca" class="block text-gray-300 mb-2">Raça</label>
    <input type="text" name="raca" id="raca" class="w-full px-3 py-2 rounded bg-[#23272f] border border-gray-700 text-gray-100 mb-4"/>
